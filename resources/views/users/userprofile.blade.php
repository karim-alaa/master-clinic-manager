...
<div class="col-lg-12 col-sm-12">
    <div class="card hovercard">
        ...
        <br/><span class="card-title">{{trans('system.nurse')}}</span>
 ...
 {!! Form::open(array('method'=>'POST','url'=>'nurse/'.Auth::id().'/updateNurse')) !!}

          

     <br/><br/> 
         {!! Form::label('email', trans('system.mail')) !!} 
           {!! Form::email('email',$nurse->email, array('class'=>'form-control')) !!}
             @if ($errors->has('email'))
...
<br/><br/>
           ...
           {!! Form::text('name',$nurse->name, array('class'=>'form-control')) !!}
             @if ($errors->has('name'))
                                    <span class="help-block">
...
<br/><br/>
           ...
           {!! Form::number('phone',$nurse->phone, array('class'=>'form-control')) !!}
             @if ($errors->has('phone'))
                                    <span class="help-block">
...
<br/><br/>
           ...
           {!! Form::text('age',$nurse->age, array('class'=>'form-control')) !!}
             @if ($errors->has('age'))
                                    <span class="help-block">
...
<br/><br/>
           ...
           {!! Form::text('address',$nurse->address, array('class'=>'form-control')) !!}
...
<br/><br/>
           ...
           {!! Form::number('nationality_id',$nurse->nationality_id, array('class'=>'form-control')) !!}
